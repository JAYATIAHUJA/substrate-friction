...
h1,h2,h3{font-family:'Space Grotesk',Inter,sans-serif;color:var(--text);
letter-spacing:-.02em}
...
align-items:center}
.hero h1{font-size:clamp(40px,6vw,64px);font-weight:700;line-height:1.05;
margin:14px 0 20px}
...
section h2{font-size:30px;margin:10px 0 24px}
...
.col h3{font-size:18px;margin-bottom:12px}
