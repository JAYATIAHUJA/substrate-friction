...
<figure class="artband" aria-hidden="true">
<img src="plots/substrate-tree.svg" alt="" loading="lazy">
<figcaption class="wrap">The substrate, in the engine's own dialect — every
sampled node carries one of this project's measured numbers. Original art,
generated by <code>scripts/render_assets.py</code> (seed 20260819).</figcaption>
</figure>
