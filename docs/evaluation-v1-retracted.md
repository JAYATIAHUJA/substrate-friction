...
> This is the v1 tree-sitter/name-matched subgraph analysis, retained as evidence and **retracted**. The live headline is `docs/evaluation.md`. The AUC here was measured on a graph in which 73.9% of resolved edges were name-collision artifacts; it is preserved to document the truncation guard, not as a result.
