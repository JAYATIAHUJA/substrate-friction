...
Plots: `docs/plots/correlation.png` (friction vs outcome), `docs/plots/pair.png` (the demo pair), `docs/plots/truncation.png` (engine vs full enumeration). Every figure is regenerated by `uv run python -m friction.harness`; none is hand-entered.
